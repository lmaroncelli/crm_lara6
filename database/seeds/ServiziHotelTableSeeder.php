...
class ServiziHotelTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach ($ServiziHotel as $servizio) {
            ...
            if (isset($servizio['dal']) && $servizio['dal'] == '0000-00-00') {
                $servizio['dal'] = null;
            }

            if ($servizio['al'] && $servizio['al'] == '0000-00-00') {
                $servizio['al'] = null;
            }
