...
<div class="row">
    <div class="col-md-12">
      <ul class="nav nav-tabs">
        ...
        <li class="nav-item">
          <a class="nav-link @if( $controller == 'ClientiController'  &&  $action == 'elencoPrecontratti')  active @endif" href="{{ route('clienti-precontratti',['cliente_id' => $cliente->id]) }}">Precontratti</a>
        </li>
