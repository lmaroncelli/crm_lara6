...
<div class="row">
    ...
    <form action="{{ route('prefatture.store-clonata', $fattura->id) }}" method="POST" enctype="multipart/form-data">            
        {!! csrf_field() !!}
        <input type="hidden" name="societa_id" id="societa_id" value="{{$fattura->societa_id}}">
